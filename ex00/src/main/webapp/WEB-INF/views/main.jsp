...
<body>
	...
	<script src="/resources/js/loadDataAjax.js"></script>
			...
			<div class="right-section">
				...
				<div class="container">
					...
					<span>4,300원</span> <a href="#" id="main-cart"> <img
						data-v-5dd5832e="" src="../img/maincart.svg" width="60px"
						height="60px"
	...
	<section id="section5">
		<div class="section5_banner">
			<img src="../img/section5_banner_icon2.png" alt="">
			<div>
				<p>친구 초대 이벤트</p>
	...
	<div id="dialog" class="dialog">
		<div class="tb">
			<div class="inner" style="max-width: 800px">
				...
				<div class="ct">
					<img src="../img/web-popup-240927-01.png" alt="" />
				</div>
			</div>
		</div>
	</div>
